      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mb-16 flex flex-col items-center justify-center text-center">
          <div className="mb-4 flex items-center gap-4">
            ...
            />
            <h1 className="text-4xl font-bold">BiliNote-2 v{appVersion}</h1>
          </div>
          <p className="text-muted-foreground mb-6 text-xl italic">
            AI 视频笔记生成工具 让 AI 为你的视频做笔记
          </p>
          <p className="text-muted-foreground mb-6 max-w-2xl text-sm">
            基于 BiliNote v2.4.4 修改的非官方社区版本，与原作者不存在官方隶属或背书关系。
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Button asChild>
              <a href="https://github.com/tfsn-xx/bilinote-2" target="_blank">
        ...
        <section className="mb-16">
          ...
          <div className="mx-auto max-w-3xl text-center">
            <p className="text-lg">
              BiliNote-2 是一个开源的 AI 视频笔记助手，支持通过哔哩哔哩、YouTube、抖音等视频链接，
