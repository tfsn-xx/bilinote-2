...
<h1 align="center" > BiliNote-2</h1>
</div>

<p align="center"><i>AI 视频笔记生成工具 让 AI 为你的视频做笔记</i></p>

> [!IMPORTANT]
> **BiliNote-2 是基于 [BiliNote](https://github.com/JefferyHcool/BiliNote) v2.4.4 修改的非官方社区版本。**
> 本项目与原作者不存在官方隶属或背书关系。感谢原作者 Jeffery Huang 和所有 BiliNote 贡献者。
> 原项目及本项目均依照 [MIT License](./LICENSE) 发布，详细署名见 [NOTICE.md](./NOTICE.md)。
...
<p align="center">
  ...
  <img src="https://img.shields.io/github/stars/tfsn-xx/bilinote-2?style=social" />
</p>

## ✨ 项目简介

BiliNote-2 是一个开源的 AI 视频笔记助手，支持通过哔哩哔哩、YouTube、抖音等视频链接，自动提取内容并生成结构清晰、重点明确的 Markdown 格式笔记。支持插入截图、原片跳转、AI 问答等功能，并在原版基础上改进了长文本总结、流式输出、失败恢复、任务状态和笔记导航等能力。

## 📝 使用文档
原项目文档可以查看 [BiliNote 文档](https://docs.bilinote.app/)。部分界面和行为可能与 BiliNote-2 不完全一致。
## 📦 桌面版下载
本仓库目前主要提供源码和 Docker 部署方式。原版桌面客户端可在 [BiliNote Releases](https://github.com/JefferyHcool/BiliNote/releases) 页面下载。
...
[![Star History Chart](https://api.star-history.com/svg?repos=tfsn-xx/bilinote-2&type=Date)](https://www.star-history.com/#tfsn-xx/bilinote-2&Date)
